...
M.configure_highlights = function()
  ...
  local enable_italics = vim.g.darcula_enable_italics
  if enable_italics == nil then
    enable_italics = true
  end
  ...
  if M.config.opt.integrations.nvim_cmp then
    ...
    hi(0, "CmpItemKindField", { fg = color.light_dim_gree })
    ...
    hi(0, "CmpItemKindProperty", { fg = color.light_dim_gree })
    hi(0, "CmpItemKindPropertyDefault", { link = "CmpItemKind" })
    hi(0, "CmpItemKindReference", { fg = color.light_dim_gree })
    ...
    hi(0, "CmpItemKindVariable", { fg = color.light_dim_gree })
  ...
  hi(0, "Macro", { fg = color.olive_green })
  ...
  hi(0, "TSComment", { fg = color.comment, italic = enable_italics })
  hi(0, "GitSignsCurrentLineBlame", { fg = color.comment, italic = enable_italics })
  hi(0, "TSConditional", { fg = color.burnt_orange })
  hi(0, "TSConstBuiltin", { fg = color.light_brown, italic = enable_italics })
  hi(0, "TSMethodCall", { fg = color.pale_taupe })
  hi(0, "TSFunctionCall", { fg = color.pale_taupe })
  hi(0, "TSConstMacro", { fg = color.light_olive_green })
  ...
  hi(0, "TSEmphasis", { fg = color.light_brown, italic = enable_italics })
  hi(0, "TSError", { fg = color.red })
  hi(0, "TSException", { fg = color.red })
  hi(0, "TSField", { fg = color.grey })
  hi(0, "TSFloat", { fg = color.light_brown })
  hi(0, "TSFuncBuiltin", { fg = color.burnt_orange, italic = enable_italics })
  ...
  hi(0, "TSTypeBuiltin", { fg = color.burnt_orange, italic = enable_italics })
  hi(0, "TSURI", { fg = color.light_brown, underline = true })
  hi(0, "TSUnderline", { fg = color.dark, underline = true })
  hi(0, "TSVariable", { fg = color.grey })
  hi(0, "TSVariableBuiltin", { fg = color.burnt_orange, italic = enable_italics })
  ...
  hi(0, "TreesitterContext", { bg = color.background, italic = enable_italics })
